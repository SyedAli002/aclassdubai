    ...
    x = (function () {
      function a(c) {
        ...
        k(this, a),
          ...
          (this.b = null),
          (this.c = null),
          (this.d = Object.assign({}, u, d)),
          (this.e = Boolean(c.getAttribute("placeholder")));
      }
      return (
        m(a, [
          {
            ...
            value: function () {
              ...
              this.d.useFullscreenPopup && (this.d.fixDropdownWidth = !1),
                ...
                this.d.showSelectedDialCode && (this.d.autoInsertDialCode = !1);
                ...
                if (
                  ...
                  (this.countryList = this._e2(
                    "ul",
                    {
                      ...
                      role: "listbox",
                      "aria-label":
                        this.d.i18n.countryListAriaLabel || "List of countries",
                    },
                    this.dropdownContent
                  )),
                  ...
                  (p += j ? " iti--fullscreen-popup" : " iti--inline-dropdown"),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ((this._a3 = function (b) {
                  ["ArrowUp", "ArrowDown", "Enter", "Escape"].includes(b.key) &&
                    (b.preventDefault(),
                    b.stopPropagation(),
          ...
          },
          {
            ...
            value: function () {
              return (
                arguments.length > 0 && arguments[0] !== b ? arguments[0] : ""
              )
                .normalize("NFD")
                .replace(/[\u0300-\u036f]/g, "")
                .toLowerCase();
          ...
          },
          {
            ...
            value: function (a) {
              ...
              for (
                var e = this._normaliseString(a), f = 0;
                f < this.p.length;
                f++
              ) {
                var g = this.p[f],
          ...
          },
          {
            key: "_y",
            value: function (a, b, c) {
              for (var d = b ? p : this.p, e = 0; e < d.length; e++)
            ...
            value: function (a) {
              ...
              if (
                ...
                this.isRTL
                  ...
                  : (this.a.style.paddingLeft = "".concat(i + 6, "px"));
              }
              if ((this._0(), c && !f)) {
                var j = this.b;
                if (
